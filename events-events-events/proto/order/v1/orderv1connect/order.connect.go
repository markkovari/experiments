...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/markkovari/events-events-events/gen/proto/order/v1"
	http "net/http"
	strings "strings"
)
...
func NewOrderServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OrderServiceClient {
	...
	orderServiceMethods := v1.File_proto_order_v1_order_proto.Services().ByName("OrderService").Methods()
