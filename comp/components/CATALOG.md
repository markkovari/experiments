...
| **platform-domain** | `platform:app@0.1.0` | auth:identity/accounts, auth:identity/authorizer, auth:identity/types, blob:store/blobstore, policy:guard/guard, quota:meter/meter, records:store/store, config/store, http/outgoing-handler, wit:reflect/composer, wit:reflect/inspector | `applier-url`, `applier-secret`, `registry`, `cluster-suffix`, `scheduler-nats`, `host-image`, `nats-image`, `id`, `platform-namespace` | 296 KiB | ✓ |
