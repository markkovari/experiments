...
class Bucket {
    ...
    async put(k, data, opts = {}) {
        ...
        if (opts.ttl) {
            ...
            h.set(internal_2.PubHeaders.MessageTTL, opts.ttl);
        }
        try {
