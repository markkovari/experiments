...
class ConsumersImpl {
    ...
    async getOrderedPushConsumer(stream, opts = {}) {
        ...
        deliver_prefix = deliver_prefix ||
            (0, internal_1.createInbox)(this.api.nc.options.inboxPrefix);
