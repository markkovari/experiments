...
class JetStreamError extends Error {
    constructor(message, opts) {
        super(message, opts);
...
class JetStreamStatusError extends JetStreamError {
    code;
...
function isMessageNotFound(err) {
    return err instanceof JetStreamApiError &&
        err.code === exports.JetStreamApiCodes.NoMessageFound;
}
...
class JetStreamApiError extends Error {
    #apiError;
