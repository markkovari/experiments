...
class PushConsumerMessagesImpl extends internal_1.QueuedIteratorImpl {
    ...
    constructor(c, userOptions = {}, internalOptions = {}) {
        ...
        if (this.ordered) {
            ...
            this.deliverPrefix = internalOptions.deliver_prefix ??
                (0, internal_1.createInbox)(this.consumer.api.nc.options.inboxPrefix);
    ...
    getConsumerOpts() {
        ...
        return Object.assign(src, {
            ...
            num_replicas: 1,
            flow_control: true,
            idle_heartbeat: (0, internal_1.nanos)(30 * 1000),
            ...
            callback: (err, msg) => {
                ...
                if (isProtocol) {
                    ...
                    if (status.isIdleHeartbeat()) {
                        const lastConsumerSequence = parseInt(msg.headers?.get("Nats-Last-Consumer") || "0");
                        const lastStreamSequence = parseInt(msg.headers?.get("Nats-Last-Stream") ?? "0");
                        this.notify({
                            type: "heartbeat",
                            lastStreamSequence,
